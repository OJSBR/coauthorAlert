...
/**
 * @file plugins/generic/coauthorAlert/tests/run.php
 *
...
define('COAUTHORALERT_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\\plugins\\generic\\coauthorAlert\\tests\\' . basename($file, '.php');
